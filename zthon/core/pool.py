...
def _stop():
    ...
    _LOG.info(_LOG_STR, f"اوبس لم يتم تنصيب جميع مكاتب السيد : {_EXECUTOR._max_workers} ")


# pylint: disable=protected-access
_LOG.info(_LOG_STR, f" تم بنجـاح تنصيب جميع مكاتب السيد : {_EXECUTOR._max_workers} ")
