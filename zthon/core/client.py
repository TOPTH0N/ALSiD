                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @S_i_D\
                                  \n\n--------بـدء تتبـع سجـل السيد syntral--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع السيد syntral--------"
                        ...
                        link = "[𐇮 ✗ ¦ ↱𝐺𝑜𝑙 𝐷. 𝑅𝑜𝑔𝑒𝑟↲ ¦ ✗  𐇮](https://t.me/S_i_D)"
                        text = (
                            "**✘ تقـريـر خطـأ السيد syntral ✘**\n\n"
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  \n\nنسجل فقـط تقريـر الخطـأ وتـاريخـه ،\
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @zqqqzq\
                                  \n\n--------بـدء تتبـع سجـل السيد syntral--------\
                                  \n- التـاريـخ : {date}\n- ايـدي الكـروب : {str(check.chat_id)}\
                                  \n- ايـدي الشخـص : {str(check.sender_id)}\
                                  \n- رابـط الرسـالـه : {await check.client.get_msg_link(check)}\
                        ...
                        text = "**✘ تقـريـر خطـأ السيد syntral✘**\n\n"
                        link = "[𐇮 ✗ ¦ ↱𝐺𝑜𝑙 𝐷. 𝑅𝑜𝑔𝑒𝑟↲ ¦ ✗  𐇮](https://t.me/S_i_D)"
