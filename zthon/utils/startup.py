    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                buttons=[(Button.url("ALSiD", "https://t.me/Syntral"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_file("@BotFather", "zthon/zilzal/23-07-19_19-33-02-808.jpg")
            await asyncio.sleep(3)
...
async def saves():
    try:
        ...
        print(str(e))
    try:
        await zedub(JoinChannelRequest("@Syntral"))
    except BaseException:
        pass
    try:
        await zedub(JoinChannelRequest("@ujijs"))
    except BaseException:
        pass
    try:
        await zedub(JoinChannelRequest("@D8BB8"))
    except BaseException:
        pass
    try:
        await zedub(JoinChannelRequest("@ss_iid"))
    except BaseException:
        pass
    try:
        await zedub(JoinChannelRequest("@rxx_x"))
    except BaseException:
        pass
    try:
